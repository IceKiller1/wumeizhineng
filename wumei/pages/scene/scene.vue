								...
								<view class="obj-info-line in-one-line">
									...
									<view class="obj-info-check in-one-line">
										...
										<view class="obj-checked" @click="changeStatus(obj.deviceId)">
											<view :class="obj.status == 0 ? 'checked-bg-checked-red' : 'checked-bg'"></view>
											<view :class="obj.status == 0 ? 'checked-btn-checked' : 'checked-btn'"></view>
										</view>
									</view>
								</view>
								<view class="obj-info-line in-one-line">
									...
									<view class="obj-info-check in-one-line">
										...
										<view class="obj-checked" @click="changeStatus(obj.deviceId)">
											<view :class="obj.status == 0 ? 'checked-bg-checked-green' : 'checked-bg'"></view>
											<view :class="obj.status == 0 ? 'checked-btn-checked' : 'checked-btn'"></view>
										</view>
									</view>
								</view>
 ...
 */
	...
	.checked-bg-checked-green{
		width: 80rpx;
		height: 40rpx;
		background-color: #32b457;
		border: 1px solid #32b457;
		border-radius: 5rpx;
		transition: all 0.5s;
	}
	.checked-btn {
